...
class SparseTensorSparseKernelDenseConv3DTest(test.TestCase):
  ...
  def _VerifyValues(self, tensor_in_sizes, filter_in_sizes, stride, rho_data = 0.1, rho_filter = 1, padding = 'SAME', dim = 3):
    ...
    with self.test_session() as sess:
      scskconv = sc_module.direct_sparse_approx_conv_kd(t1ind, t1val, t1sh, t2ind, t2val, t2sh, strides, padding, dim);
      approx_scskconv = sc_module.direct_sparse_approx_conv_kd(t1ind, t1val, t1sh, t2ind, t2val, t2sh, strides, padding, dim);
