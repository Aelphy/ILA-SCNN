...
# XXX Modify according to path
sc_module = tf.load_op_library('/home/gsilvano/src/tensorflow-timo/bazel-bin/tensorflow/core/user_ops/sparse_tensor_dense_conv_3d.so')
