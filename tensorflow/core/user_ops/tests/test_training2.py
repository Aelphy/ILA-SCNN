...
dc1 = create_dense_conv_layer(filter_in_sizes, rho_filter, strides, padding, approx, dim, var_list, dense_data, "sc1")
...
with tf.Session(config=config) as sess:
  ...
  for i in range(1, nr_batchs):
    ...
    rsc1 = tf.get_default_graph().get_tensor_by_name("sc1/dense_weights:0")
