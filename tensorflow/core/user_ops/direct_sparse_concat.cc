...
REGISTER_OP("DirectSparseConcat")
  ...
  .Input("in_indices1: Tindices")
  .Input("in_values1: T")
  .Input("in_shape1: Tindices")
  .Input("in_block_channel_mapping1: int32")
  .Input("in_indices2: Tindices")
  .Input("in_values2: T")
  .Input("in_shape2: Tindices")
  .Input("in_block_channel_mapping2: int32")
