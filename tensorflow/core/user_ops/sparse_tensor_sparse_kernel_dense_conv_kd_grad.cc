...
class SparseTensorSparseKernelDenseConvKDFilterGrad : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    //get input data
    const Tensor *in_indices, *in_values, *in_shape, *filter_indices, *filter_values, *filter_shape, *gradients;
    ...
    sparseCuboidConvKDFilterGrad(in_ind, in_vals, in_sh, f_ind, f_vals, f_sh, grads, stride_, filter_dim, output_map);
    ...
    assert(output_map.size() == out_vals.size());
