...
#pragma omp critical
                {
                    ...
                    //all_values_ptr->insert(all_values_ptr->end(), conv_update_val.begin(), conv_update_val.end());
                    //all_keys_1d_ptr->insert(all_keys_1d_ptr->end(), conv_update_idx_1d.begin(), conv_update_idx_1d.end());
                }
            }
