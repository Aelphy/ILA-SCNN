...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            [loss, pred, reg_ops] = MODEL.get_model(pointclouds_pl, labels_pl, is_training_pl, TENSOR_IN_SIZES, NUM_CLASSES, initializer = initializer)
        ...
        for epoch in range(MAX_EPOCH):
            ...
            train_one_epoch(sess, ops, reg_ops, train_writer)
...
def train_one_epoch(sess, ops, reg_ops, train_writer):
