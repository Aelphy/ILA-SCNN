...
def get_model(sparse_data, train_labels, is_training, tensor_in_sizes, num_classes = 10, scope = "mn256-", initializer = None, regularizer = None):
  ...
  d1 = 0.01
  net, tensor_in_sizes = ld.create_sparse_conv_layer(sd_converted, [3,3,3,1,8], tensor_in_sizes, strides, padding, dim, d1, "K-ABS", name = scope + "sc1", initializer=initializer)
  ...
  d2 = 0.03
  net, tensor_in_sizes = ld.create_sparse_conv_layer(net, [3,3,3,8,16], tensor_in_sizes, strides, padding, dim, d2, "K-ABS", name = scope + "sc4", initializer=initializer)
  ...
  d3 = 0.07
  net, tensor_in_sizes = ld.create_sparse_conv_layer(net, [3,3,3,16,24], tensor_in_sizes, strides, padding, dim, d3, "K-ABS", name = scope + "sc7", initializer=initializer)
