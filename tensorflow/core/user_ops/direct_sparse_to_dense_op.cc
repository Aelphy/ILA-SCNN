...
// Operator to convert sparse representations to dense with sparse backpropagation
...
#define REGISTER_KERNELS(type, index_type)                             \
  REGISTER_KERNEL_BUILDER(Name("DirectSparseToDense")                  \
                              .Device(DEVICE_CPU)                      \
                              .TypeConstraint<type>("T")               \
                              .TypeConstraint<index_type>("Tindices"), \
                          DirectSparseToDense<type, index_type>);
